import define1 from "./colorlegends.js";

function _1(md){return(
md`<div style="color: grey; font: 13px/25.5px var(--sans-serif); text-transform: uppercase;"><h1 style="display: none;">Revenue by music format, 1973–2018</h1><a href="https://d3js.org/">D3</a> › <a href="/@d3/gallery">Gallery</a></div>
...
function _legend(swatches,chart){return(
swatches({color: chart.scales.color, columns: "130px 4", marginLeft: 10})
)}

function _chart(d3,data,series,colors)
{  
...
md`For a similar chart using [Observable Plot](/plot)’s concise API, see [this notebook](https://observablehq.com/@observablehq/plot-stacking-order), that emphasizes the various ways data can be stacked.`
)}
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ["music.csv", {url: new URL("./files/ejemplo.csv", import.meta.url), mimeType: "text/csv", toString}]
  ]);
  main.builtin("FileAttachment", runtime.fileAttachments(name => fileAttachments.get(name)));
  main.variable(observer()).define(["md"], _1);
  main.variable(observer("legend")).define("legend", ["swatches","chart"], _legend);
  main.variable(observer("chart")).define("chart", ["d3","data","series","colors"], _chart);
